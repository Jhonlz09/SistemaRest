...
public class Emisor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dirección del Establecimiento :");

        jLabel2.setText("Nombres y Apellidos / Razón social :");

        jLabel3.setText("Nombre Comercial :");

        jLabel4.setText("Dirección de Matriz :");

        jLabel5.setText("Código del Establecimiento :");

        jLabel6.setText("Código del Punto de Emisión :");

        jLabel7.setText("Contribuyente Especial /  Numero de resolución : ");

        jLabel8.setText("Obligado a Contabilidad :");

        jLabel9.setText("Tipo de Ambiente :");

        jLabel10.setText("RUC :");

        jLabel11.setText("Tipo de Emision :");

        jLabel12.setText("Agente de Retención :");

        jLabel13.setText("Régimen Microempresas :");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Producción ", "Prueba" }));
        ...
        setSize(new java.awt.Dimension(530, 587));
